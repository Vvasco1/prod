...
resource "aws_subnet" "pub_a" {
  vpc_id                  = aws_vpc.prod.id
  cidr_block              = "10.10.0.0/24" # VPC 내 범위 지정. 0,1 = pub / 10,11 = web / 20,21 = WAS / 30,31 = DB
